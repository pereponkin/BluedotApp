...
## Blue Dot Agent 0.2.1

- Добавлено переключение языка интерфейса между русским и английским.
- Сокращён интервал опроса панели для более отзывчивой работы.
- Обновлены автономные пакеты для Windows, macOS Intel и macOS Apple Silicon.

Расширения для браузеров в этот выпуск не входят.
